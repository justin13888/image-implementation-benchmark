// Shared AVIF encode implementation for libavif with selectable codec backend.
...
class AvifEncodeBenchBase : public BenchmarkImplementation {
 public:
  explicit AvifEncodeBenchBase(avifCodecChoice codec) : codec_(codec) {}
